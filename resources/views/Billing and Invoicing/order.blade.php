                        ...
                        <tr class="border-b hover:bg-gray-100 transition text-sm">
                            ...
                            <td class="p-3 text-center">
                                @if($job->status === 'completed')
                                    <span class="inline-block bg-green-100 text-green-800 px-3 py-1 rounded-lg text-xs font-medium">Completed</span>
                                @elseif($job->status === 'in_progress')
                                    <span class="inline-block bg-yellow-100 text-yellow-800 px-3 py-1 rounded-lg text-xs font-medium">In Progress</span>
                                @else
                                    <span class="inline-block bg-gray-200 text-gray-800 px-3 py-1 rounded-lg text-xs font-medium">Pending</span>
                                @endif
                            </td>
                        </tr>
                    @empty
