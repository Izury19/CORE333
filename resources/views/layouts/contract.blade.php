...
<body x-data="{ sidebarOpen: false }">
  ...
  {{-- Footer --}}
  <footer class="bg-[#1f1f1f] text-white w-full p-3 shadow-lg flex justify-center items-center fixed bottom-0 left-0">
    <div class="flex items-center justify-center space-x-3 w-full max-w-screen-xl mx-auto px-4">
